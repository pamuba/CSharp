...
class Program
{
    ...
    static void Main()
    {
        ...
        Key key = new Key("test", "demo1", "key2");
        ...
        //product.Add("name", "stylish couch");
        //product.Add("productid", 123);
        //product.Add("purchasable", true);

        //// Convert the map into an Aerospike Bin
        ...
        //Bin myThirddBin = new Bin("price", 24.04);
        ////client.Put(null, myKey, myBin, mySecondBin, myThirddBin);
        ////Record myRecord = client.Get(null, myKey, "price","description");
        ////Record myRecord = client.Get(null, myKey);
        //Record myRecord = client.Get(null, myKey, "price");
        //int currentGeneration = myRecord.generation;
        //Console.WriteLine(currentGeneration);
        //// Modify the data based on your requirements
        //// ...

        //Bin updatedBins = new Bin("price", 25.04);
        ...
        //Console.WriteLine(client.Exists(null, myKey));
    ...
    public static double addItem(Key key, String itemDescr, double cost)
    {
        ...
        Record record1 = client.Operate(null, key,
        Operation.Get("cost"),
        Operation.Append(new Bin("items", itemDescr + ",")),
        Operation.Add(new Bin("totalItems", 1)),
        Operation.Add(new Bin("cost", cost)),
